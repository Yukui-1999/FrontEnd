  ...
  render() {
    return (
      <div>
        ...
        />
        <br /><br />
        <Link to={{ pathname: '/TeacherCenter/ChangeTeaInfo', state: { username: this.state.username, psw: this.state.psw } }}>
          <Button>
            编辑信息
          </Button>
        </Link>

        <Link to={{ pathname: '/TeacherCenter/TeaChangePSW', state: { username: this.state.username, psw: this.state.psw } }}>
